        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ route('home') }}" class="brand-logo">
                <span style="color: rebeccapurple;">Drissho Kabbo</span>
            </a>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{ route('home.applications') }}" class="ai-icon" aria-expanded="false">
                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                            <span class="nav-text">Applications</span>
                        </a>
                    </li>
                    <li><a href="{{ route('home.contacts') }}" class="ai-icon" aria-expanded="false">
